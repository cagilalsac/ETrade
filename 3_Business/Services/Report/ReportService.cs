...
namespace Business.Services.Report
{
    ...
    public class ReportService : IReportService
    {
        ...
        public ReportService(RepoBase<Product> productRepo, RepoBase<ProductStore> productStoreRepo,
            RepoBase<Store> storeRepo, RepoBase<Category> categoryRepo)
        {
        ...
        */
        public List<ReportItemModel> GetList(ReportFilterModel filter, bool useInnerJoin = false) 
        {
            ...
            var productQuery = _productRepo.Query(); // Products sorgusu
            var categoryQuery = _categoryRepo.Query(); // Categories sorgusu,
            var storeQuery = _storeRepo.Query(); // Stores sorgusu
            var productStoreQuery = _productStoreRepo.Query(); // ProductStores sorgusu
