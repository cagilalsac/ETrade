...
namespace Business.Services
{
                                                  ...
                                                  // new'lenerek enjekte edilerek kullanılacak concrete (somut) bir class'tır.
    {
        ...
        public ProductService(RepoBase<Product> productRepo, RepoBase<ProductStore> productStoreRepo)
        {
        ...
        public Result Update(ProductModel model) // Update işlemi: model kullanıcının view üzerinden doldurup gönderdiği objedir 
		{
            ...
            _productStoreRepo.Delete(ps => ps.ProductId == model.Id); // önce ürünün ilişkili ürün mağaza kayıtlarını repository üzerinden siliyoruz
        ...
        {
            _productStoreRepo.Delete(ps => ps.ProductId == id); // önce ürünün ilişkili ürün mağaza kayıtlarını repository üzerinden siliyoruz
		...
		{
			Product entity = _productRepo.Query().SingleOrDefault(p => p.Id == id); // parametre olarak gelen id'ye göre tek ürünü çektik
